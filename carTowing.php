...
@keyframes spin {
  ...
  100% { transform: rotate(360deg); }
                ...
                <div class="col-4" id="top-left">
                    <div id="form">
                        <div id="pickup-location"> <h4>Where are you:</h4>
                            ...
                            <div class="words">
                            <button class="btn btn-dark  m-1" id="showit">Show car Towers Near You</button>
                                <div id="status"></div>
                                <div id="radius"></div>
                            </div> 
                        </div>
    ...
    $sql = 'SELECT * FROM `items` WHERE  `item` = "Car towing" LIMIT 5';
    // ERROR IS HERE ^^^^^^^^^^^^^^^^^^
    ...
    if ($result->num_rows > 0) {
     ...
     echo "<input type='submit' name='submit' value='Request Tower'/>";
    echo "</form>";
    mysqli_close($conn);
                ?>
            </div>
