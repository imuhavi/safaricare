  ...
  100% { transform: rotate(360deg); }
    ...
    <body>
        ...
        <div class="container-fluid">
                ...
                <div class="col-4" id="top-left">
                    <div id="form">
                        <div id="pickup-location"> <h4>Where are you:</h4>
                            ...
                            <button type="button" class="btn btn-dark  m-1" id="show-map" onclick="retrieveFunction()">Search</button>
                            <div class="words">
                                <div id="status"></div>
                                <div id="radius"></div>
                            </div> 
            ...
            <button class="btn btn-dark  m-1"  id="showit">Show car Mechanics Near You</button>
            <br>
            <br>
    ...
    if ($result->num_rows > 0) {
     ...
     echo "<input type='submit' name='submit' value='Request Mechanic'/>";
    echo "</form>";
    mysqli_close($conn);
                ?>
            </div>
